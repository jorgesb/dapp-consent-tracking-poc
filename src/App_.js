...
window.db = orbitdb.docstore('test1db', {indexBy: 'id'});
window.web3 = web3;
...
function fetchContent() {
    ...
    var tmp = window.db.get('1');
    console.dir(tmp);
    console.log("Retrieving content from orbit DB:", tmp.doc);
}
...
console.log('Starting with nodes...');
deployStorage();
storeContent('123456789');
fetchContent();
